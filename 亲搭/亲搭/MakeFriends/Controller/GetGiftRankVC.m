...
#import "RankModel.h"
#import "RankCell.h"
@interface GetGiftRankVC ()<UITableViewDelegate,UITableViewDataSource>

@property(strong,nonatomic) UITableView *tableView;
@property(strong,nonatomic) NSMutableArray *dataArr;
@end

@implementation GetGiftRankVC
...
- (void)viewDidLoad {
    ...
    for (int i = 0; i<5; i++) {
        dict = @{ @"name":[NSString stringWithFormat:@"小不点_%d",i+1],
                  ...
                  @"sex": i%2==0 ? @"man" : @"woman",
                  @"sumInfo":[NSString stringWithFormat:@"收到的礼物 %d 个",500-i]
                  }.mutableCopy;
