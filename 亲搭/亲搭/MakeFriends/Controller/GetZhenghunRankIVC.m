...
#import "RankModel.h"
#import "RankCell.h"
@interface GetZhenghunRankIVC ()<UITableViewDelegate,UITableViewDataSource>

@property(strong,nonatomic) UITableView *tableView;
@property(strong,nonatomic) NSMutableArray *dataArr;
@end

@implementation GetZhenghunRankIVC
...
- (void)viewDidLoad {
    ...
    for (int i = 0; i<5; i++) {
        dict = @{ @"name":[NSString stringWithFormat:@"小不点_%d",i+1],
                  ...
                  @"sex": i%2==0 ? @"man" : @"woman",
                  @"sumInfo":[NSString stringWithFormat:@"被征婚 %d 次",20-i]
                  }.mutableCopy;
